...
//main scene
 ...
 //前面的“”要跟着你在tilemap里面放的那个tileset名字，后面的“”跟着你上面load image取得名字a.k.a第一个“”）
    ...
    this.player = this.physics.add.sprite(100, 100, 'up').setScale(0.30);
    ...
    this.physics.add.collider(this.player, this.Treeslayer); //这个，应该，也是跟上面一样set Collider的，but你应该是要加这个才可以真的不会撞到？所以应该是一起的
    this.physics.add.collider(this.player, this.Stonelayer);
  } 
  /////////////////// end of create //////////////////////////////

  update() {
// check for cave A ////// numbers unknow
...
// check for cave B ////// numbers unknow
  //   if ( this.player.x > 1255
  //     && this.player.y > 368 && this.player.y < 431 ) {
...
// check for cave C ////// numbers unknow
  //   if ( this.player.x > 1255
  //     && this.player.y > 368 && this.player.y < 431 ) {
